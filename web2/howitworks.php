<?php 
	...
	$title 			= "How Coolsulpting Works and Treatment Process";
	$bodyClass		= "interior howitworks";
	$description 	= "CoolSculpting is a non-surgical, non-invasive method to target those stubborn \"muffin-tops\" and belly fat. Learn about how CoolSculpting cellulite treatment procedures work. ";
		...
		<div class="wrapper clearfix">
			...
			<div class="twothird alpha">
				...
				<div class="content-box">
					...
					<a class="btn btn-blue btn-sm" href="/gallery.php">View Before and After Photos</a>
				</div>
