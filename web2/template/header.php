	...
	<header id="global-header">
		...
		<nav id="global-nav">
			<ul class="wrapper clearfix">
				<li id="nav-home"><a href="/">Home<br />&nbsp;</a></li>
				<li id="nav-about"><a href="about.php">About<br/> Dr. Gerrish</a></li>
				<li id="nav-how"><a href="howitworks.php">How It<br/> Works</a></li>
				<li id="nav-gallery"><a href="coolsculpting-photos.php">Before and<br/> After Photos</a></li>
				<li id="nav-patients"><a href="coolsculpting-patient-testimonials.php">Hear from<br/> Real Patients</a></li>
