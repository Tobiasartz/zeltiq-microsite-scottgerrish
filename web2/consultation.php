<?php 
	...
	$title 			= "Schedule a CoolSculpting Cellulite Treatment Physician Consultation";
	$bodyClass		= "interior consultation";
	$description 	= "Zeltiq CoolSculpting has helped countless individuals get rid of stubbon fat through a simple, non-invasive, non-surgical procedure. Schedule your own consultation with a certified physician today.";
...
?>
		...
		<div class="wrapper clearfix">
			...
			<div class="twothird alpha">
				<form id="consultForm" action="http://cl.exct.net/subscribe.aspx?lid=3912735" name="subscribeForm" method="post" novalidate="novalidate">
					<input type="hidden" name="thx" value="http://scottgerrish.coolsculpting.com.php53-8.ord1-1.websitetestlink.com/thanks.php" />
					<input type="hidden" name="err" value="http://scottgerrish.coolsculpting.com.php53-8.ord1-1.websitetestlink.com/consultation.php?error" />
					...
					<ul>
						...
						<li><label for="area">Areas of Concern <small>(select all that apply)</small></label></li>
